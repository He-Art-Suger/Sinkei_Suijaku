...
public class Client5 extends JFrame implements MouseListener
{
	...
	public void ptChange(int p1, int p2)
    {
    	int n;
	...
	{	
		...
		public Game(){
			...
			/*
			ImageIcon background1=new ImageIcon("tex4.jpg");	//盤面背景
		    Image img1=background1.getImage();
		    Image temp1=img1.getScaledInstance(800,530,Image.SCALE_SMOOTH);
		    background1=new ImageIcon(temp1);
		    JLabel back1=new JLabel(background1);
		    back1.setLayout(null);
		    back1.setBounds(0,5,800,530);
		    container.add(back1);
		    */
	...
	public static void main(String[] args)
	{
		...
		// クライアントオブジェクトの用意
		Client5 oclient = new Client5(player); // 引数としてオセロオブジェクト、プレイヤオブジェクトを渡す
