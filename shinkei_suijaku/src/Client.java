...
public class Client extends JFrame implements MouseListener
{
	...
	class LoginInterface extends JFrame
	{
		...
		class Match extends JFrame
		{
		    ...
		    Match(String title)
		    {
		            ...
		            label = new JLabel("神経衰弱しちゃUNO!?");
		            label.setFont((new Font(Font.DIALOG_INPUT, Font.BOLD, 60)));
		            label.setBounds(50,100,700,60);
	...
	public static void main(String[] args)
	{
		...
		// クライアントオブジェクトの用意
		Client oclient = new Client(player); // 引数としてオセロオブジェクト、プレイヤオブジェクトを渡す
